	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_Target
			{
                ...
                if(C.r > 0.5){
                    if(cntG == 3) return float4(0.0, 1.0, 0.0, 1.0);
                    else if(cntB == 3) return float4(0.0, 0.0, 1.0, 1.0);
                    return float4(1.0,0.0,0.0,1.0);
                } else if (C.g > 0.5){
                    if(cntB == 3)return float4(0.0, 0.0, 1.0, 1.0);
                    else if(cntB + cntG == 5)return float4(1.0,0.0,0.0,1.0);
                    return float4(0.0, 1.0, 0.0, 1.0);
                } else if (C.b > 0.5){
                    if(cntB + cntG == 5)return float4(1.0,0.0,0.0,1.0);
                    else if(cntG == 3) return float4(0.0, 1.0, 0.0, 1.0);
                ...
                if (C.r < 0.5) { //cell is alive
                    if (cnt == 2 || cnt == 3) {
                        ...
                        return float4(0.0,0.0,1.0,1.0);
                        //return C.b > 0.5 ? 
                        //    float4(0.0,0.0,1.0,1.0):float4(0.0,1.0,0.0,1.0);
                    } else {
